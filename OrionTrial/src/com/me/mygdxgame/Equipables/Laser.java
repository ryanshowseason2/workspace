...
public class Laser extends CounterMeasure
{
	...
	public Laser(World w, Ship s, ArrayList<ViewedCollidable> aliveThings, float range )
	{
		super(w, s, aliveThings, range, new Image( new Texture(Gdx.files.internal("data/laser.png") ) ) );
