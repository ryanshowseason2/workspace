...
public class MagneticWave extends CounterMeasure
{
	...
	public MagneticWave(World w, Ship s, ArrayList<ViewedCollidable> aliveThings, float range )
	{
		super(w, s, aliveThings, range, new Image( new Texture(Gdx.files.internal("data/magnet.png") ) ) );
